...
// Object.keys(person).forEach((key) => { // Object.keys(person) возвращ массив объекта с которым работатет .forEach((key)и возвращает в консоль значения ключей нашего объекта
//   console.log(person[key])
// })
